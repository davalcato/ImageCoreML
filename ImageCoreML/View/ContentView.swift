...
struct ContentView: View {
    ...
    var body: some View {
        NavigationView {
            VStack {
                ...
                :
                    ZStack {
                        ...
                        Text(self.imageCModel.classificationText)
                            ...
                            .background(Rectangle().foregroundColor(Color.init(.systemBackground)).opacity(0.33).cornerRadius(10))
            ...
            }, label: { Image(systemName: "photo")}), trailing: Button(action: {
                self.takePhoto = true
                self.imageCModel.classificationText = "Tap to Classification"
                self.isPresented.toggle()
            ...
            isPresented: self.$isPresented) { ShowImagePicker(
                image: self.$imageCModel.image,
